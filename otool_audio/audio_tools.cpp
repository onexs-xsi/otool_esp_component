...
// ============================================================================
// 音频文件元数据表 - 统一管理所有音频文件信息
// ============================================================================

// 函数指针类型：用于获取音频文件的起始地址和大小
...
struct AudioFileMetadata {
    ...
    AudioDataGetter data_getter;  // 新增：函数指针，用于获取PCM数据
};
...
esp_err_t audio_tools::record_and_playback_test(uint32_t record_duration_seconds,
                                                bool loop_playback,
